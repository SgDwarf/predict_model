...
def main(page: ft.Page):
    ...
    model_prepod_path = r'data_generating\code\predict_model\SMOTE_data\neural_network\model_prepod_nn.h5'
    model_vkr_path = r'data_generating\code\predict_model\SMOTE_data\neural_network\model_vkr_nn.h5'
    scaler_path = 'data_generating/code/predict_model/SMOTE_data/scaler.pkl'
    
    model_prepod = load_model(model_prepod_path)
    model_vkr = load_model(model_vkr_path)
