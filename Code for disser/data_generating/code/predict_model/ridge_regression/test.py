...
def main(page: ft.Page):
    ...
    model_prepod_path = 'data_generating/code/predict_model/SMOTE_data/gradient_boosting/model_prepod_gb.pkl'
    model_vkr_path = 'data_generating/code/predict_model/SMOTE_data/gradient_boosting/model_vkr_gb.pkl'
