...
def main(page: ft.Page):
    ...
    model_prepod_path = r'data_generating\code\predict_model\SMOTE_data\linear_regression\model_prepod.pkl'
    model_vkr_path = r'data_generating\code\predict_model\SMOTE_data\linear_regression\model_vkr.pkl'
