...
def main(page: ft.Page):
    ...
    model_prepod_path = r'data_generating\code\predict_model\SMOTE_data\polynomial_regression\model_prepod_poly_ridge.pkl'
    model_vkr_path = r'data_generating\code\predict_model\SMOTE_data\polynomial_regression\model_prepod_poly.pkl'
