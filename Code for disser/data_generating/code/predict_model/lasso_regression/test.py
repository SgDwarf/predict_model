...
def main(page: ft.Page):
    ...
    model_prepod_path = r'data_generating\code\predict_model\SMOTE_data\lasso_regression\model_prepod_lasso.pkl'
    model_vkr_path = r'data_generating/code/predict_model/SMOTE_data/lasso_regression/model_vkr_lasso.pkl'
